...
// $output = '';
 $b_id=$_POST["b_id"];
 $re_drum_number=$_POST["re_drum_number"];
 $bry_id=$_POST["bry_id"];
 ...
 //echo $re_diy_id;
//}
if($re_l_id!="" && $bry_id !=""&& $re_diy_day!=""&& $re_drum_number=="0") {
  ...
  echo $re_diy_name;
      ...
      $total1=mysqli_num_rows($result1);
              ...
              if($total1=="1"){
             $sql="INSERT INTO `report_drum`( `b_id`, `re_drum_name`, `	re_drum_day`, `re_drum_idname`, `re_drum_poin`, `re_drum_number`) VALUES ('$b_id','$re_diy_name','$re_diy_day','$re_l_id','$re_diy_poin','$re_drum_number')";

...
<link rel="preload" href="fonts/Sarabun-Regular.ttf?v=3" as="font" type="font/ttf">
<link rel="preload" href="fonts/Sarabun-Bold.ttf?v=3" as="font" type="font/ttf">
<style id="pageOrientationStyle">@page{size:A4 portrait;margin:8mm}</style>
<style>
@font-face{font-family:"SarabunLocal";src:url("fonts/Sarabun-Regular.ttf?v=3") format("truetype");font-style:normal;font-weight:400;font-display:swap}
@font-face{font-family:"SarabunLocal";src:url("fonts/Sarabun-SemiBold.ttf?v=3") format("truetype");font-style:normal;font-weight:600;font-display:swap}
@font-face{font-family:"SarabunLocal";src:url("fonts/Sarabun-Bold.ttf?v=3") format("truetype");font-style:normal;font-weight:700;font-display:swap}
@font-face{font-family:"SarabunLocal";src:url("fonts/Sarabun-ExtraBold.ttf?v=3") format("truetype");font-style:normal;font-weight:800;font-display:swap}
